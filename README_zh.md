...
<p align="center">
  <b>环境快照</b> · M-4 / M-B · 截至 <b>2026-07-22</b>
</p>
...
预构建包把同一次发行的 SPA、公开投影、Python bridge、四个技能、运行时配置和校验清单绑定在一起。只需要 **Python 3.10+**；依赖由包内精确锁定的 `requirements-runtime.txt` 安装，**不需要 Node.js**。解压缩并进入前端目录后：
