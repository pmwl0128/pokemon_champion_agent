function getKOChanceText(damageIn, move, defender, field, isBadDreams, isItemlessAttacker = false) {
    ...
    var eotText = [];
    var toxicCounter = 0;
    var eotDict = getAllEndOfTurnEffects(
        defender, field, isBadDreams, preventsHeal, preventsHealItem, move, isItemlessAttacker
    );
...
function getAllEndOfTurnEffects(defender, field, isBadDreams, preventsHeal, preventsHealItem, move, isItemlessAttacker) {
