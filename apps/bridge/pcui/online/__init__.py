"""Public online API (apps/design.md §7): the parts of the online site the static
projection cannot serve — the DeepSeek-proxied fact QA (llm.qa) behind anonymous rate
