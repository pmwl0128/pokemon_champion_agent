...
# Repo layout: apps/bridge/pcui/paths.py -> project root three levels up. An installed wheel
...
# Query CLIs get resident workers; team deliberately does NOT (apps/design.md §4.1 🚩:
