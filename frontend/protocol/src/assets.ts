/**
 * Image asset-pack contract (frontend/design.md §12): TypeScript mirror of
 * frontend/assets/asset-manifest.schema.json — field names stay snake_case because this schema
