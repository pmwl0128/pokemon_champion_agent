...
`runner.run_cli`, so results never depend on worker health (frontend/design.md §4.1)."""
...
#
# Size it from the host with `frontend/bridge/tools/capacity_benchmark.py`. On the 2-vCPU host the
