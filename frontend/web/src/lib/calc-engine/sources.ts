 ...
 * (frontend/design.md §7.1). Kept as raw strings; worker.ts evals them.
 *
 * The path reaches out of frontend/web to the installed skill (the single source — no copy that could
